...
## Project Structure
    ...
    ├── testapiautocatalog_100270  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_100270`
...
2. Clone this repo and `cd testapiautocatalog_100270`
